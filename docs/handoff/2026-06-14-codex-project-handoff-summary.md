...
| 状态面 | 当前事实 | 证据 |
| --- | --- | --- |
| 仓库主线 | `main` / `origin/main` at `900ca318 docs: record melwater production release` | `git log -1` |
...
| 发布证据文档 | `docs/audits/2026-06-14-melwater-production-release-qa.md` | 已 push 到 `origin/main` |
| 生产状态 | 公网站点 200，review-state API ok，Docker containers healthy，ops report ok，mock alert drill ok | 生产 release QA 与 ops report |

注意：`900ca318` 是发布后的文档记录提交，没有重新部署；生产代码正确映射到 `7a09e358`。
...
- 生产 release 代码是 `7a09e358`，不要误认为文档提交 `900ca318` 已被部署。
